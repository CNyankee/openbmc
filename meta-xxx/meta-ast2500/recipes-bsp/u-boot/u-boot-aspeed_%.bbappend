...
FILESEXTRAPATHS_append_yyy-ast2500:= "${THISDIR}/files/CVE-2020-10648:"

# the meta-phosphor layer adds this patch, which conflicts
# with the intel layout for environment
SRC_URI_remove_yyy-ast2500 = " file://0001-configs-ast-Add-redundnant-env.patch"
...
AUTOBOOT_SRC_URI = " \
    ...
    "
SRC_URI_append_yyy-ast2500 += "${@bb.utils.contains('IMAGE_FSTYPES', 'intel-pfr', PFR_SRC_URI, '', d)}"
SRC_URI_append_yyy-ast2500 += "${@bb.utils.contains('EXTRA_IMAGE_FEATURES', 'debug-tweaks', '', AUTOBOOT_SRC_URI, d)}"
do_install_append () {
